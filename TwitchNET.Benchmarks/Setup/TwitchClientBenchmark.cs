...
namespace TwitchNET.Benchmarks.TwitchNET.Setup
{
    public class TwitchClientBenchmark
    {
        ...
        public void TwitchClient_TwitchLib()
        {
            ...
            twitchBot.Initialize(new ConnectionCredentials("thatnandotho","oauth:12361823618237612"));
            
            for (int i = 0; i < 100; i++)
            {twitchBot.OnReadLineTest(MESSAGE);
            }
            

            twitchBot.OnMessageReceived += (sender, args) => { };
        }
    }
}